...
public class MainFrm extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/pngtree-visualization-of-a-warehouse-with-shelves-racks-boxes-and-forklift-in-image_3631455.jpg"))); // NOI18N
        ...
        jLabel1.setText("PHẦN MỀM QUẢN LÝ KHO HÀNG MÁY TÍNH");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(obj.equals(btnDangNhap)){
            new Login(this, rootPaneCheckingEnabled);
            Login login = new Login((java.awt.Frame) SwingUtilities.getWindowAncestor(this), true);
            login.setVisible(true);
        }else {
            new Register(this, rootPaneCheckingEnabled);
            Register register = new Register((java.awt.Frame) SwingUtilities.getWindowAncestor(this), true);
