...
public class AddNhaCungCap extends javax.swing.JDialog implements ActionListener{

    /**
     * Creates new form AddNhaCungCap
     */
    public AddNhaCungCap(java.awt.Frame parent, boolean modal, NhaCungCap nhaCungCap) {
        super(parent, modal);
        initComponents();
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddNhaCungCap dialog = new AddNhaCungCap(new javax.swing.JFrame(), true, new NhaCungCap());
    ...
    public void actionPerformed(ActionEvent e) {
        // thực hiện các hàng động
        var obj = e.getSource();
        if(obj.equals(btnClear)){
            this.dispose();
        }
    }
